/**
 * Courses (Kurse) Page - Kursübersicht
 * EXAKT 1:1 nach Foto
 */
...
function Courses({ user }) {
  ...
  const courses = [
    { id: 1, name: 'Pitch', thumbnail: '#4B5563' },
    { id: 2, name: 'Interview', thumbnail: '#4B5563' },
    { id: 3, name: 'Präsentation', thumbnail: '#4B5563' },
    { id: 4, name: 'Rede', thumbnail: '#4B5563' },
    { id: 5, name: 'Vortrag', thumbnail: '#4B5563' },
    { id: 6, name: 'Verhandlung', thumbnail: '#4B5563' },
    { id: 7, name: 'Verkauf', thumbnail: '#4B5563' },
    { id: 8, name: 'Smalltalk', thumbnail: '#4B5563' },
    { id: 9, name: 'Storytelling', thumbnail: '#4B5563' },
    { id: 10, name: 'Argumentation', thumbnail: '#4B5563' },
    { id: 11, name: 'Ausstrahlung', thumbnail: '#4B5563' },
    { id: 12, name: 'Sonstiges', thumbnail: '#4B5563' }
  ];
  ...
  return (
    <div className="courses-page">
      ...
      <div className="courses-account-btn" onClick={() => navigate('/account')}>
        {getUserInitial()}
      </div>
      ...
      <div className="courses-content">
        {/* Header */}
        <h1 className="courses-title">Kurse</h1>
      ...
      <nav className="menubar-new">
        ...
        <div className="menubar-right">
          <div className="menubar-line"></div>
          <div className="menubar-icons">
            <button className="menubar-icon active" onClick={() => navigate('/courses')}>
              <svg viewBox="0 0 24 24" fill="currentColor">
