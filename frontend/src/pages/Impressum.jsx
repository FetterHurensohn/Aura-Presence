/**
 * Impressum Page
 * Konvertiert von docs/legal/IMPRESSUM.md
 */
  ...
  return (
    <div className="legal-page">
      <div className="legal-container">
        ...
        <p>
          [Ihr Firmenname / Name des Einzelunternehmens]<br />
        ...
        <p>
          ...
          <strong>Website:</strong> [Ihre Website-URL]
        </p>
        
        <h2>Registereintrag</h2>
        <p>
          [Falls zutreffend: Amtsgericht [Ort], Registernummer [HRB-Nummer]]
        </p>
        ...
        <p>
          [Falls zutreffend:<br />
          Berufsbezeichnung: [z.B. Softwareentwickler, Coach]<br />
          Zuständige Kammer: [Name der Kammer]<br />
          Verliehen in: [Land]<br />
          Es gelten folgende berufsrechtliche Regelungen: [Link zu den Regelungen]<br />
          Diese können auch eingesehen werden unter: [Link zur Einsichtsstelle]]
        </p>
        ...
        <p className="legal-footer">
          <strong>Hinweis:</strong> Dieses Impressum wurde mit größter Sorgfalt erstellt, 
