  ...
  return (
    <div className="dashboard-new">
      ...
      <nav className="menubar-new">
        ...
        {/* Mitte: Großer Button */}
        <button className="menubar-center-btn" onClick={handleStartSession}>
